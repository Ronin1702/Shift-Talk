...
const MakeLogo = ({ carMake }) => {
    if (carMake === 'acura') {
        return (
            <div>
                <img src={acura} alt='Acura Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'alfaromeo') {
        return (
            <div>
                <img src={alfaromeo} alt='Alfa Romeo Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'astonmartin') {
        return (
            <div>
                <img src={astonmartin} alt='Aston Martin Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'audi') {
        return (
            <div>
                <img src={audi} alt='Audi Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'bentley') {
        return (
            <div>
                <img src={bentley} alt='Bentley Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'bmw') {
        return (
            <div>
                <img src={bmw} alt='BMW Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'buick') {
        return (
            <div>
                <img src={buick} alt='Buick Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'cadillac') {
        return (
            <div>
                <img src={cadillac} alt='Cadillac Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'chevrolet') {
        return (
            <div>
                <img src={chevrolet} alt='Chevrolet Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'chrysler') {
        return (
            <div>
                <img src={chrysler} alt='Chrysler Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'daewoo') {
        return (
            <div>
                <img src={daewoo} alt='Daewoo Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'dodge') {
        return (
            <div>
                <img src={dodge} alt='Dodge Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'ferrari') {
        return (
            <div>
                <img src={ferrari} alt='Ferrari Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'fiat') {
        return (
            <div>
                <img src={fiat} alt='Fiat Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'fisker') {
        return (
            <div>
                <img src={fisker} alt='Fisker Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'ford') {
        return (
            <div>
                <img src={ford} alt='Ford Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'eagle') {
        return (
            <div>
                <img src={eagle} alt='Eagle Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'geo') {
        return (
            <div>
                <img src={geo} alt='Geo Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'genesis') {
        return (
            <div>
                <img src={genesis} alt='Genesis Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'gmc') {
        return (
            <div>
                <img src={gmc} alt='GMC Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'honda') {
        return (
            <div>
                <img src={honda} alt='Honda Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'hummer') {
        return (
            <div>
                <img src={hummer} alt='Hummer Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'hyundai') {
        return (
            <div>
                <img src={hyundai} alt='Hyundai Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'infiniti') {
        return (
            <div>
                <img src={infiniti} alt='Infiniti Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'isuzu') {
        return (
            <div>
                <img src={isuzu} alt='Isuzu Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'jaguar') {
        return (
            <div>
                <img src={jaguar} alt='Jaguar Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'jeep') {
        return (
            <div>
                <img src={jeep} alt='Jeep Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'kia') {
        return (
            <div>
                <img src={kia} alt='Kia Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'lamborghini') {
        return (
            <div>
                <img src={lamborghini} alt='Lamborghini Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'landrover') {
        return (
            <div>
                <img src={landrover} alt='Land Rover Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'lexus') {
        return (
            <div>
                <img src={lexus} alt='Lexus Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'lincoln') {
        return (
            <div>
                <img src={lincoln} alt='Lincoln Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'lotus') {
        return (
            <div>
                <img src={lotus} alt='Lotus Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        )
    } else if (carMake === 'maserati') {
        return (
            <div>
                <img src={maserati} alt='Maserati Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        )
    } else if (carMake === 'mazda') {
        return (
            <div>
                <img src={mazda} alt='Mazda Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'mclaren') {
        return (
            <div>
                <img src={mclaren} alt='Mclaren Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'maybach') {
        return (
            <div>
                <img src={maybach} alt='Maybach Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'mercedesbenz') {
        return (
            <div>
                <img src={mercedesbenz} alt='Mercedes-Benz Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'mercury') {
        return (
            <div>
                <img src={mercury} alt='Mercury Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'mini') {
        return (
            <div>
                <img src={mini} alt='Mini Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'mitsubishi') {
        return (
            <div>
                <img src={mitsubishi} alt='Mitsubishi Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'nissan') {
        return (
            <div>
                <img src={nissan} alt='Nissan Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'oldsmobile') {
        return (
            <div>
                <img src={oldsmobile} alt='Oldsmobile Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'pontiac') {
        return (
            <div>
                <img src={pontiac} alt='Pontiac Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'panoz') {
        return (
            <div>
                <img src={panoz} alt='Panoz Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'plymouth') {
        return (
            <div>
                <img src={plymouth} alt='Plymouth Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'polestar') {
        return (
            <div>
                <img src={polestar} alt='Polestar Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'porsche') {
        return (
            <div>
                <img src={porsche} alt='Porsche Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'ram') {
        return (
            <div>
                <img src={ram} alt='Ram Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'rivian') {
        return (
            <div>
                <img src={rivian} alt='Rivian Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'rollsroyce') {
        return (
            <div>
                <img src={rollsroyce} alt='Rolls Royce Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'saab') {
        return (
            <div>
                <img src={saab} alt='Saab Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'saturn') {
        return (
            <div>
                <img src={saturn} alt='Saturn Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'scion') {
        return (
            <div>
                <img src={scion} alt='Scion Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'smart') {
        return (
            <div>
                <img src={smart} alt='Smart Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'subaru') {
        return (
            <div>
                <img src={subaru} alt='Subaru Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'suzuku') {
        return (
            <div>
                <img src={suzuki} alt='Suzuki Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'tesla') {
        return (
            <div>
                <img src={tesla} alt='Tesla Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'toyota') {
        return (
            <div>
                <img src={toyota} alt='Toyota Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'volkswagen') {
        return (
            <div>
                <img src={volkswagen} alt='Volkswagen Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        );
    } else if (carMake === 'volvo') {
        return (
            <div>
                <img src={volvo} alt='Volvo Logo' style={{ width: "20%", height: "20%" }}></img>
            </div>
        )
    };
};
